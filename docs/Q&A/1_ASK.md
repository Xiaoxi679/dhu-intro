...
* 善用第三方脚本，像网页端的 [Tampermonkey](https://www.tampermonkey.net/) 就能承载许多优质插件，如：[搜索引擎结果净化](https://greasyfork.org/zh-CN/scripts/14178)等
...
* [提问的智慧](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/blob/main/README-zh_CN.md)：非常建议阅读的文章，读后在任何社区提问时都不会写出”帮我个忙”的标题。
